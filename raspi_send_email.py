...
DESTINATION_EMAILS = os.getenv("EMAIL_DESTINATION").split(",")  # Split into a list
...
if __name__ == '__main__':
    ...
    scripts = ['raspi_combo_bulletin.py', 'raspi_consecutive_absences.py', 'raspi_principals_attendance_DOWNLOADS.py']
    # scripts = ['raspi_combo_bulletin.py', 'raspi_consecutive_absences.py', 'raspi_principals_attendance_DOWNLOADS.py']
